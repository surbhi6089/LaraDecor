        ...
        <div class="flex justify-between h-16">
            <div class="flex main-nav">
                ...
                <nav class="nav-links">
                    ...
                    <div class="dropdown-toggle" data-bs-toggle="dropdown">Categories</div>
                    <div class="dropdown-menu">
                        <a href="/categories/1" class="dropdown-item">Rugs/Carpets</a>
                        <a href="/categories/2" class="dropdown-item">Paintings</a>
                        <a href="/categories/3" class="dropdown-item">Statues</a>
                        <a href="/categories/4" class="dropdown-item">WallDecor</a>
                    </div>
                </nav>
                <form action="{{url('/search')}}">
                    <div class="header-search">
                        <input type="search" name = "search" placeholder="Search" aria-label="Search" aria-describedby="search-addon" />
                        <a href="{{ url('/search') }}"><button class="search-btn"><i class="fa fa-search"></i></button></a>
                    </div>
                </form>
